# Copied from https://github.com/gilt/schema-evolution-manager/blob/master/lib/schema-evolution-manager/version.rb
class Version

  VERSION_FILE = File.join(".", "VERSION") unless defined?(VERSION_FILE)

  attr_reader :major, :minor, :micro

  def initialize(version_string)
    Preconditions.check_not_blank(version_string, "version_string cannot be blank")
    Git.assert_valid_tag(version_string)
